...
Chat with your PDFs using a powerful **Retrieval-Augmented Generation (RAG)** backend built with **Python, Flask, and LangChain**, and a responsive **React + Vite** frontend.
